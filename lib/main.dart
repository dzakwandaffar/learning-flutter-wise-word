...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: MaterialApp(
        title: "Tebak-Tebakan Nih Yeee :p",
        theme: ThemeData(
          useMaterial3: true, 
          colorScheme: ColorScheme.fromSeed(seedColor: Color.fromARGB(255, 245, 30, 184))),
        home: MyHomePage(),
      ), // MaterialApp
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      //background app
      backgroundColor: const Color.fromARGB(255, 243, 199, 251),
              ...
              ElevatedButton.icon(
                onPressed: () {
                  ...
                  ScaffoldMessenger.of(context)
                    ...
                    ..showSnackBar(
                      SnackBar(
                        content: Text("Kata-kata '${appState.current}' ini, kamu jadikan mutiara :)"),
                      ),
                    );
                }, 
                icon: Icon(icon),
...
class BigCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      color: Color.fromARGB(255, 248, 255, 221),
      child: Padding(
...
class FavoritePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      child: ListView(
        children: [
          Text("Ada ${appState.favorites.length} kata-kata mutiara nihh", 
    ...
    return Scaffold(
      body: ListView(
        children: [
          Center(
            child: Text(
              "Kamu punya ${historyState.history.length} mutiara di history loh!",
              style: const TextStyle(
                fontSize: 35,
